---
title: "Playing with ggplot2 on the diamond dataset"
author: "Matt Spinelli"
date: "March 1, 2017"
...
In the workshop on ggplot2 at Miami University (for preparing for the 2017 ASA DataFest competion), we ended by exploring the diamonds dataset by making the following violin/box plot:
...
Let's take this example and see how we can extend it to get more information out of the plot by adding color information adjusting the y-axis. First let's take a look at the diamond dataset and see what the min/max carat size is:
